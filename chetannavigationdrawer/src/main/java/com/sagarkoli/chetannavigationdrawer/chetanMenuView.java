...
public class chetanMenuView extends RelativeLayout {
    ...
    public chetanMenuView(Context context) {
        this(context, null);
    }

    public chetanMenuView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public chetanMenuView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void readAttributes(AttributeSet attributeSet) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attributeSet, R.styleable.chetanMenuView);

        try {
            mBackgroundDrawableId = typedArray.getResourceId(R.styleable.chetanMenuView_sk_menu_background, DEFAULT_DRAWABLE_ATTRIBUTE_VALUE);
            mHeaderViewId = typedArray.getResourceId(R.styleable.chetanMenuView_sk_menu_header, DEFAULT_LAYOUT_ATTRIBUTE_VALUE);
            mFooterViewId = typedArray.getResourceId(R.styleable.chetanMenuView_sk_menu_footer, DEFAULT_LAYOUT_ATTRIBUTE_VALUE);
        } finally {
            typedArray.recycle();
        }
    }
    ...
    private void initialize() {
        ViewGroup rootView = (ViewGroup) inflate(getContext(), R.layout.sk_view_menu, this);
