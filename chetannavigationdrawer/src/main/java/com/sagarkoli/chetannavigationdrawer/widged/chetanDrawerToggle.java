package com.sagarkoli.chetannavigationdrawer.widged;
...
import com.sagarkoli.chetannavigationdrawer.chetanDrawerLayout;

import static androidx.drawerlayout.widget.DrawerLayout.DrawerListener;
import static android.view.View.OnClickListener;


public class chetanDrawerToggle implements DrawerListener {

    /**
     * Allows an implementing Activity to return an {@link chetanDrawerToggle.Delegate} to use
    ...
    private final chetanDrawerLayout mDuoDrawerLayout;
     ...
     * @param chetanDrawerLayout           The DrawerLayout to link to the given Activity's ActionBar
     * @param openDrawerContentDescRes  A String resource to describe the "open drawer" action
     *                                  for accessibility
     * @param closeDrawerContentDescRes A String resource to describe the "close drawer" action
     *                                  for accessibility
     */
    public chetanDrawerToggle(Activity activity, chetanDrawerLayout chetanDrawerLayout,
                              @StringRes int openDrawerContentDescRes,
                              @StringRes int closeDrawerContentDescRes) {
        this(activity, null, chetanDrawerLayout, null, openDrawerContentDescRes,
                closeDrawerContentDescRes);
    }

    public chetanDrawerToggle(Activity activity, chetanDrawerLayout duoDrawerLayout,
    ...
    <T extends Drawable & DrawerToggle> chetanDrawerToggle(Activity activity, Toolbar toolbar,
                                                           chetanDrawerLayout duoDrawerLayout, T slider,
                                                           @StringRes int openDrawerContentDescRes,
                                                           @StringRes int closeDrawerContentDescRes) {
        if (toolbar != null) {
    ...
    private static class HoneycombDelegate implements Delegate {
        ...
        chetanDrawerToggleHoneycomb.SetIndicatorInfo mSetIndicatorInfo;
        ...
        public Drawable getThemeUpIndicator() {
            return chetanDrawerToggleHoneycomb.getThemeUpIndicator(mActivity);
        }
        ...
        public void setActionBarUpIndicator(Drawable themeImage, int contentDescRes) {
            ...
            mSetIndicatorInfo = chetanDrawerToggleHoneycomb.setActionBarUpIndicator(
        ...
        public void setActionBarDescription(int contentDescRes) {
            mSetIndicatorInfo = chetanDrawerToggleHoneycomb.setActionBarDescription(
