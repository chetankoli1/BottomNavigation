...
public class chetanOptionView extends RelativeLayout {
    ...
    public chetanOptionView(Context context) {
        this(context, null);
    }

    public chetanOptionView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public chetanOptionView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize();
    }

    private void initialize() {
        ViewGroup rootView = (ViewGroup) inflate(getContext(), R.layout.sk_view_option, this);
