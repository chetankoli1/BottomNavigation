...
/**
 * Created by chetan koli
 * date:- 5/05/2020
 * contact as = whatsapp = 7773925706
 */
...
public final class chetanBottomNavigation extends FrameLayout {
    ...
    private ArrayList<chetanBottomNavigationCell> cells;
    ...
    public chetanBottomNavigation(Context context) {
        super(context);
    ...
    public chetanBottomNavigation(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.models = new ArrayList<>();
        this.cells = new ArrayList<>();
        this.selectedId = -1;
    ...
    public chetanBottomNavigation(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public final ArrayList<chetanBottomNavigationCell> getCells() {
        return this.cells;
    }
    ...
    private void setAttributeFromXml(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.chetanBottomNavigation, 0, 0);
    ...
    public final void add(final chetanBottomNavigation.Model model) {
        final chetanBottomNavigationCell cell = new chetanBottomNavigationCell(this.getContext());
        ...
        cell.setOnClickListener(new ClickListener() {
            ...
            public void onClickItem(Model item) {
                if (chetanBottomNavigation.this.isShowing(model.getId())) {
                    chetanBottomNavigation.this.onReselectListener.onReselectItem(model);
                }

                if (!cell.isEnabledCell() && !chetanBottomNavigation.access$isAnimating$p(chetanBottomNavigation.this)) {
                    chetanBottomNavigation.show$default(chetanBottomNavigation.this, model.getId(), false, 2, null);
                    chetanBottomNavigation.this.onClickedListener.onClickItem(model);
                } else if (chetanBottomNavigation.access$getCallListenerWhenIsSelected$p(chetanBottomNavigation.this)) {
                    chetanBottomNavigation.access$getOnClickedListener$p(chetanBottomNavigation.this).onClickItem(model);
                }
            }
        });
        cell.disableCell();
    ...
    private void updateAllIfAllowDraw() {
        if (this.allowDraw) {
            Iterable<chetanBottomNavigationCell> $this$forEach$iv = this.cells;

            for (Object element$iv : $this$forEach$iv) {
                chetanBottomNavigationCell it = (chetanBottomNavigationCell) element$iv;
    ...
    private void anim(chetanBottomNavigationCell cell, int id, boolean enableAnimation) {
    ...
    // $FF: synthetic method
    static void anim$default(chetanBottomNavigation var0, chetanBottomNavigationCell var1, int var2, boolean var3, int var4, Object var5) {
        if ((var4 & 4) != 0) {
            var3 = true;
        }
    ...
    public final void show(int id, boolean enableAnimation) {
        ...
        for (int var4 = (this.models).size(); i < var4; ++i) {
            ...
            chetanBottomNavigation.Model model = (chetanBottomNavigation.Model) var10000;
            var10000 = this.cells.get(i);
            chetanBottomNavigationCell cell = (chetanBottomNavigationCell) var10000;
            if (model.getId() == id) {
    ...
    // $FF: synthetic method
    public static void show$default(chetanBottomNavigation var0, int var1, boolean var2, int var3, Object var4) {
        if ((var3 & 2) != 0) {
            var2 = true;
        }
    ...
    public final chetanBottomNavigation.Model getModelById(int id) {
        Iterable<Model> $this$forEach$iv = this.models;
        Iterator<Model> var4 = $this$forEach$iv.iterator();

        chetanBottomNavigation.Model it;
        do {
            if (!var4.hasNext()) {
                return null;
            }
    ...
    public final chetanBottomNavigationCell getCellById(int id) {
    ...
    public final int getModelPosition(int id) {
        ...
        for (int var3 = (this.models).size(); i < var3; ++i) {
            chetanBottomNavigation.Model item = this.models.get(i);
            if (item.getId() == id) {
                return i;
            }
        }
    ...
    public final void setCount(int id, String count) {
        chetanBottomNavigation.Model var10000 = this.getModelById(id);
        if (var10000 != null) {
            int pos = this.getModelPosition(id);
            var10000.setCount(count);
            chetanBottomNavigationCell var5 = this.cells.get(pos);
            var5.setCount(count);
        }
    }
    ...
    public final void clearCount(int id) {
        ...
        if (var10000 != null) {
            ...
            chetanBottomNavigationCell var4 = this.cells.get(pos);
            var4.setCount("empty");
        }
    }
    ...
    // $FF: synthetic method
    public static ReselectListener access$getOnReselectListener$p(chetanBottomNavigation $this) {
        return $this.onReselectListener;
    }

    // $FF: synthetic method
    public static void access$setOnReselectListener$p(chetanBottomNavigation $this, ReselectListener var1) {
        $this.onReselectListener = var1;
    }

    // $FF: synthetic method
    public static boolean access$isAnimating$p(chetanBottomNavigation $this) {
        return $this.isAnimating;
    }

    // $FF: synthetic method
    public static void access$setAnimating$p(chetanBottomNavigation $this, boolean var1) {
        $this.isAnimating = var1;
    }

    // $FF: synthetic method
    public static ClickListener access$getOnClickedListener$p(chetanBottomNavigation $this) {
        return $this.onClickedListener;
    }

    // $FF: synthetic method
    public static void access$setOnClickedListener$p(chetanBottomNavigation $this, ClickListener var1) {
        $this.onClickedListener = var1;
    }

    // $FF: synthetic method
    public static boolean access$getCallListenerWhenIsSelected$p(chetanBottomNavigation $this) {
        return $this.callListenerWhenIsSelected;
    }

    // $FF: synthetic method
    public static void access$setCallListenerWhenIsSelected$p(chetanBottomNavigation $this, boolean var1) {
        $this.callListenerWhenIsSelected = var1;
    }

    // $FF: synthetic method
    public static BezierView access$getBezierView$p(chetanBottomNavigation $this) {
        return $this.bezierView;
    }

    // $FF: synthetic method
    public static void access$setBezierView$p(chetanBottomNavigation $this, BezierView var1) {
   ...
   static class chetanBottomNavigation$anim$$inlined$apply$lambda$1 implements ValueAnimator.AnimatorUpdateListener {
        ...
        public final void onAnimationUpdate(ValueAnimator it) {
            ...
            if (newX > this.$beforeX) {
                chetanBottomNavigation.access$getBezierView$p(this.this$0).setBezierX(f * (newX - this.$beforeX) + this.$beforeX);
            } else {
                chetanBottomNavigation.access$getBezierView$p(this.this$0).setBezierX(this.$beforeX - f * (this.$beforeX - newX));
            }

            if (f == 1.0F) {
                chetanBottomNavigation.access$setAnimating$p(this.this$0, false);
            }
    ...
    final static class chetanBottomNavigation$anim$$inlined$apply$lambda$2 implements ValueAnimator.AnimatorUpdateListener {
        ...
        public final void onAnimationUpdate(ValueAnimator it) {
            float f = it.getAnimatedFraction();
            chetanBottomNavigation.access$getBezierView$p(this.this$0).setProgress(f * 2.0F);
        }
    }
