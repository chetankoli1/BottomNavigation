...
final class chetanBottomNavigationCell extends RelativeLayout {
    ...
    private chetanBottomNavigation.ClickListener onClickListener;
    ...
    public chetanBottomNavigationCell(Context context) {
        super(context);
        this.count = "empty";
    ...
    public chetanBottomNavigationCell(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.count = "empty";
        this.iconSize = Utils.dip(this.getContext(), 48);
    ...
    public chetanBottomNavigationCell(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            if (this.count != null && this.count.equals("empty")) {
                ...
                if (this.count != null) {
                    ...
                    if (var10000.length() >= 3) {
                        chetanBottomNavigationCell var11 = this;
        ...
        if (Build.VERSION.SDK_INT >= 21 && !this.isEnabledCell) {
            ...
            this._$_findCachedViewById(R.id.fl).postDelayed(new Runnable() {
                public final void run() {
                    try {
                        chetanBottomNavigationCell.this._$_findCachedViewById(R.id.fl).setBackgroundColor(0);
    ...
    public final chetanBottomNavigation.ClickListener getOnClickListener() {
        return this.onClickListener;
    }

    public final void setOnClickListener(chetanBottomNavigation.ClickListener value) {
        ...
        if (var10000 != null) {
            var10000.setOnClickListener(new OnClickListener() {
                public final void onClick(View it) {
                    chetanBottomNavigationCell.this.getOnClickListener().onClickItem(new chetanBottomNavigation.Model(0,0));
                }
            });
        }
    ...
    private void initializeView() {
        this.allowDraw = true;
        View var10001 = LayoutInflater.from(this.getContext()).inflate(R.layout.chetan_navigation_cell, this);
    ...
    // $FF: synthetic method
    public static void enableCell$default(chetanBottomNavigationCell var0, boolean var1, int var2, Object var3) {
        if ((var2 & 1) != 0) {
            var1 = true;
        }
    ...
    // $FF: synthetic method
    static void animateProgress$default(chetanBottomNavigationCell var0, boolean var1, boolean var2, int var3, Object var4) {
        if ((var3 & 2) != 0) {
            var2 = true;
        }
    ...
    // $FF: synthetic method
    public static float access$getProgress$p(chetanBottomNavigationCell $this) {
        return $this.progress;
    }

    // $FF: synthetic method
    public static void access$setProgress$p(chetanBottomNavigationCell $this, float var1) {
    ...
    final class MeowBottomNavigationCell$animateProgress$$inlined$apply$lambda$1 implements ValueAnimator.AnimatorUpdateListener {
        // $FF: synthetic field
        final chetanBottomNavigationCell this$0;
        // $FF: synthetic field
        ...
        MeowBottomNavigationCell$animateProgress$$inlined$apply$lambda$1(chetanBottomNavigationCell var1, boolean var2, long var3, boolean var5) {
            this.this$0 = var1;
        ...
        public final void onAnimationUpdate(ValueAnimator it) {
            ...
            chetanBottomNavigationCell.access$setProgress$p(this.this$0, this.$enableCell$inlined ? f : 1.0F - f);
        }
    }
}
